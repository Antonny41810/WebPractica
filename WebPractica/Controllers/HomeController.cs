...
namespace WebPractica.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult DescargarExcel(DateTime FechaInicio , DateTime FechaFin)
        {
            string fe1 = FechaInicio.ToShortDateString();
            string fe2 = FechaFin.ToShortDateString();
